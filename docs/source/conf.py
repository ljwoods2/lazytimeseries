...
import lazytimeseries  # noqa



# -- Project information -----------------------------------------------------

project = "lazytimeseries"
copyright = (
    "2024, Lawson Woods. "
...
htmlhelp_basename = "lazytimeseriesdoc"
...
latex_documents = [
    (master_doc, "lazytimeseries.tex", "lazytimeseries Documentation",
     "lazytimeseries", "manual"),
]
...
man_pages = [
    (master_doc, "lazytimeseries", "lazytimeseries Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "lazytimeseries", "lazytimeseries Documentation",
     author, "lazytimeseries", "Hackathon code for a lazy timeseries and analysis code",
     "Miscellaneous"),
]
